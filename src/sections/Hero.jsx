...
import { dashboard, line } from '../assets'


const Hero = () => {
  return (
    <section className='relative pt-56 pb-40 max-lg:pt-52 max-lg:pb-12 max-md:pt-36 max-md:pb-32 max-sm:pb-12'>
        <Element name='home'>
          <div className="container flex flex-col items-center justify-center">
              <h1 className='text-[60px] max-lg:text-[40px] max-sm:text-[25px] text-center leading-[84px] max-md:leading-12'>Webpage Management for Individuals and Teams</h1>
